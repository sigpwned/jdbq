...
/**
 * Thrown when Jdbi tries to build a Collector, but cannot determine the element type intended for
 * it.
 */
@SuppressWarnings("serial")
public class ElementTypeNotFoundException extends JdbqException {
