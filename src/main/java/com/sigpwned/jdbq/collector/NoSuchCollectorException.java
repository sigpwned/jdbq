...
/**
 * Thrown when Jdbi tries to produce a result Collector but doesn't have a factory to produce it
 * with.
 */
@SuppressWarnings("serial")
public class NoSuchCollectorException extends JdbqException {
